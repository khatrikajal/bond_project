...
from ..services.bond_estimation_service import create_or_get_application, update_step
from ..models.AgencyRatingChoice import RatingAgency, CreditRating
from config.common.response import APIResponse   # ⬅️ Standardized wrapper
...
class CreditRatingCreateView(APIView):
    ...
    def post(self, request, company_id):
        ...
        # If soft deleted, restore instead of creating new
        if soft_deleted_record:
            ...
            # 🔥 New Fields
            soft_deleted_record.is_verified = request.data.get("is_verified", False)
            soft_deleted_record.verification_notes = request.data.get("verification_notes", "")
