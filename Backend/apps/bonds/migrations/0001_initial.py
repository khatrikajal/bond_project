...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating_agency', models.CharField(choices=[('CRISIL', 'CRISIL'), ('ICRA', 'ICRA'), ('CARE', 'CARE Ratings'), ('IND-RA', 'India Ratings & Research'), ('BWR', 'Brickwork Ratings'), ('ACUITE', 'Acuité Ratings'), ('INFOMERICS', 'Infomerics')], max_length=100)),
                ('credit_rating', models.CharField(choices=[('AAA', 'AAA'), ('AA+', 'AA+'), ('AA', 'AA'), ('AA-', 'AA-'), ('A+', 'A+'), ('A', 'A'), ('A-', 'A-'), ('BBB+', 'BBB+'), ('BBB', 'BBB'), ('BBB-', 'BBB-'), ('BB+', 'BB+'), ('BB', 'BB'), ('BB-', 'BB-'), ('B+', 'B+'), ('B', 'B'), ('B-', 'B-'), ('C', 'C'), ('D', 'Default / D'), ('UNRATED', 'Unrated / No Rating')], max_length=10)),
