# Generated by Django 5.2.6 on 2025-11-11 13:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id_updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_users', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id_updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_otps', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'OTP',
        ...
        migrations.AddIndex(
            model_name='otp',
            index=models.Index(fields=['user', 'otp_type', 'is_used'], name='otp_user_id_40fb2a_idx'),
        ),
    ]
