    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company", "is_del"],
                        name="roi_borrowi_company_09a163_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="capital_details_old",
                        to="issuer_kyc.companyinformation",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company", "is_del"],
                        name="roi_capital_company_baa974_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "upload_letter",
                    models.FileField(
                        blank=True, null=True, upload_to="uploads/credit_ratings/"
                    ),
                ),
                ("is_del", models.SmallIntegerField(default=0)),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="credit_ratings_old",
                        to="issuer_kyc.companyinformation",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company", "is_del"],
                        name="roi_credit__company_b681c0_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="roi_fund_positions",
                        to="issuer_kyc.companyinformation",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company", "is_del"],
                        name="roi_fund_po_company_2f454d_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="profitability_ratios_old",
                        to="issuer_kyc.companyinformation",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company", "is_del"],
                        name="roi_profita_company_2b0675_idx",
                    )
                ],
            },
        ),
